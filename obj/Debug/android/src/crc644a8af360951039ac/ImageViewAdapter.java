...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DigiPresence.ImageViewAdapter, DigiPresence", ImageViewAdapter.class, __md_methods);
	}
	...
	public ImageViewAdapter ()
	{
		...
		if (getClass () == ImageViewAdapter.class)
			mono.android.TypeManager.Activate ("DigiPresence.ImageViewAdapter, DigiPresence", "", this, new java.lang.Object[] {  });
	}
